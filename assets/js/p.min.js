...
let templateComment = `<div class="comments" id="comment0" style="display:block">
<div class="profile">
  <img src="./assets/img/1.gif"></div>
...
buttonComment.addEventListener('click', function(){
    ...
    templateComment = `<div class="comments" id="comment0" style="display:block">
    <div class="profile">
      <img src="${imgAva}"></div>
    <div class="comment-content">
      <p class="name">
